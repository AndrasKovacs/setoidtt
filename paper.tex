...
We provide a implementation of the elaborator described in Section
\ref{sec:extending_elaboration}. It is a standalone Haskell program which takes
as input a file or a string containing a surface expression, and outputs the
