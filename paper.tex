...
\begin{notation}[Spines]\label{not:spines}
...
definition of elaboration. Insertion is defined by recursion on the $A$ core
type, as follows.
\begin{alignat*}{3}
...
\todo{example for meta solution, more references}
...
We briefly discuss what we can and cannot say about the currently presented
...
We can still say something about what kind of work our elaborator does. For
this, we consider a translation from core terms to surface terms, the obvious
``forgetful'' translation, which maps terms to surface counterparts. Now, this
is an ``evil'' construction on core terms, since it does not preserve
definitional equality. We shall only use this evil notion in the following
statement.
