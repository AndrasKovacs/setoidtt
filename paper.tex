...
$\einferblank$ conform to the specification \ref{TODO}. This follows by induction on surface syntax and analyzing the definitions, while also relying on properties of substitution, metasubstitution, $\unify$ and $\mathsf{freshMeta}$. \qed
\end{theorem}
