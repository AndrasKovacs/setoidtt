...
%% \begin{itemize}
%% \item Elaboration is implemented in the style of Coquand's algorithm \cite{coquand1996algorithm},
%%       where elaboration is interleaved with normalization-by-evaluation.
%% \end{itemize}
