...
\begin{itemize}
  ...
  \item \emph{Polymorphic subtyping}. In some prior works, e.g.\ in
    ...
    implemented in any dependently typed setting. Hence we omit it as well. GHC
    also seems to abandon polymorphic subtyping in recent developments of
    impredicative inference \cite{serrano2020a}.
\end{itemize}
...
setup, we inherit consistency, canonicity and decidability of conversion. We
