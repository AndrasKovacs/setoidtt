...
\end{alignat*}
\end{example}
%% In the core syntax, all abstractions and applications must be notated. Thanks to
%% elaboration, in the surface syntax we may omit some of these.
...
Now, let us assume that $B'$ is not an implicit function type and not
meta-headed. Then, we have the following case, where we solve a telescope domain
to be empty.
\begin{alignat*}{3}
