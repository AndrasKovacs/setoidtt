...
import qualified Data.Primitive.Unlifted.Class as UA
...
instance UA.PrimUnlifted (Array a) where
  type Unlifted (Array a) = MutableArrayArray# RealWorld

  toUnlifted# (Array (UA.MutableUnliftedArray arr)) = arr
  {-# inline toUnlifted# #-}
  fromUnlifted# arr = Array (UA.MutableUnliftedArray arr)
  {-# inline fromUnlifted# #-}
