...
vAppLocals t env ls = case (env, ls) of
   (_         , S.Empty            ) -> t
   (Snoc env u, S.Define ls _ _ _ _) -> vAppLocals t env ls
   (Snoc env u, S.Bind   ls x a au ) -> vAppInline (vAppLocals t env ls) (S u) au Expl
   _                                 -> impossible
